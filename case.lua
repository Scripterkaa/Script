...
function main()
    pcall(function()
        ...
        local ts = game:GetService("TweenService")  
        local info = TweenInfo.new(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out, 0, false, 0)
        local tween1 = ts:Create(playerpos, info, {CFrame = CFrame.new(-473.005859, 66.1158829, 49.8783569, 0.996191859, 0, 0.0871884301, 0, 1, 0, -0.0871884301, 0, 0.996191859) * CFrame.new(0,0,10)})
        tween1:Play()
        wait(0.3)
        tar.Humanoid.Health = 0
        tar.Humanoid.Health = 0
        ...
        punch()
        punch()
        local tween2 = ts:Create(playerpos, info, {CFrame = CFrame.new(-494.072296, 66.1158829, 33.5412102, 0.996191859, 0, 0.0871884301, 0, 1, 0, -0.0871884301, 0, 0.996191859) * CFrame.new(0,0,10)})
        tween2:Play()
        wait(0.3)
        tar.Humanoid.Health = 0
        tar.Humanoid.Health = 0
        ...
        punch()
        punch()
        local tween3 = ts:Create(playerpos, info, {CFrame = CFrame.new(-510.708252, 66.1158829, 51.5089378, 0.996191859, 0, 0.0871884301, 0, 1, 0, -0.0871884301, 0, 0.996191859) * CFrame.new(0,0,10)})
        tween3:Play()
        wait(0.3)
        tar.Humanoid.Health = 0
        tar.Humanoid.Health = 0
